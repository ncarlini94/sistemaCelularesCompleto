...
const ExportToExcel = ({ data, fileName, sheetName }) => {
  ...
  const exportToExcel = () => {
    ...
    const transformedData = data.map(item => ({
        ...
        "Cargo": item.cargo,
        "Activo": item.activo,
        "Usuario Sade": item.usuarioSade,
        "Mail": item.mail,
        "Jurisdiccion": item.jurisdiccionData.jurisdiccion,
        "Reparticion 1": item.jurisdiccionData.reparticion1,
        "Reparticion 2": item.jurisdiccionData.reparticion2,
        "Reparticion 3": item.jurisdiccionData.reparticion3,
